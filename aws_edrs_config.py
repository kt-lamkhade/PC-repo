...
def test_module():
    ...
    sn_all = ec2_client.describe_subnets(Filters=filters,VpcId='vpc-0ec4fd6ab42babd17')
    for sn in sn_all['Subnets'] :
        print(sn['SubnetId'])
    
    sg_all = ec2_client.describe_security_groups(Filters=filters,VpcId='vpc-0ec4fd6ab42babd17')
